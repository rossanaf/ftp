...
// Instanciation of inherited class
  ...
  $query = $db->prepare("SELECT athlete_totaltime, athlete_finishtime, athlete_chip FROM athletes WHERE athletes.athlete_started >= 5 AND athletes.athlete_race_id = ? AND athletes.athlete_sex = 'M'");

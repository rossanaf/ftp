<?php
  ...
  $order_column = array("live_pos","live_bib","live_firstname","live_lastname","live_category","live_team","live_t1","live_t2","live_t3","live_t4","live_t5","live_finishtime");
  $output = array();
  $query = 'SELECT * FROM live LEFT JOIN teams ON live.live_team_id=teams.team_id WHERE live_sex="M" AND live_race='.$_POST['raceId'].' ';
